...
interface AddNewTripFromProps {
  navigation: any
}

const AddNewTripFrom: FC<AddNewTripFromProps> = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      {queryResults.map(result =>
        ...
        <TouchableOpacity
          key={result.id}
          onPress={() => navigation.navigate("Add New Trip To", { origin: result })}
        >
